...
const duluxColors = [
  ...
  // GROUP COLORS
  { name: "Whites", code: "SW1", hex: "#F7F5EB" },
  { name: "Pastels", code: "SP2", hex: "#E2DDD3" },
  { name: "Naturals", code: "SN3", hex: "#D4CDC0" },
  { name: "Neutrals", code: "SN4", hex: "#BDB4A8" },
  { name: "Greys Light", code: "SG5", hex: "#A7A2A5" },
  { name: "Greys Dark", code: "SG6", hex: "#777377" },
  { name: "Bolds Red", code: "SB7", hex: "#8A303F" },
  { name: "Bolds Purple", code: "SB8", hex: "#763960" },
  { name: "NZ Cool", code: "NZ9", hex: "#A0B2B9" },
  { name: "NZ Warm", code: "NZ10", hex: "#A85C60" },

  // S SERIES (CORE RANGE)
  { name: "S01", code: "S01", hex: "#903249" },
  { name: "S02", code: "S02", hex: "#923345" },
  { name: "S03", code: "S03", hex: "#A73944" },
  { name: "S04", code: "S04", hex: "#A52B2D" },
  { name: "S05", code: "S05", hex: "#C92C2B" },
  { name: "S06", code: "S06", hex: "#AD4430" },
  { name: "S07", code: "S07", hex: "#E44836" },
  { name: "S08", code: "S08", hex: "#EE4318" },
  { name: "S09", code: "S09", hex: "#CE5324" },
  { name: "S10", code: "S10", hex: "#D97B2D" },
  { name: "S11", code: "S11", hex: "#DA853A" },
  { name: "S12", code: "S12", hex: "#DE862B" },
  { name: "S13", code: "S13", hex: "#F3A225" },
  { name: "S14", code: "S14", hex: "#FCBA2D" },
  { name: "S15", code: "S15", hex: "#FCBF2A" },
  { name: "S16", code: "S16", hex: "#FBCC2A" },
  { name: "S17", code: "S17", hex: "#FBD624" },
  { name: "S18", code: "S18", hex: "#E9DD24" },
  { name: "S19", code: "S19", hex: "#CFE423" },
  { name: "S20", code: "S20", hex: "#BCE12A" },
  { name: "S21", code: "S21", hex: "#9EDA2C" },
  { name: "S22", code: "S22", hex: "#7BAD3B" },
  { name: "S23", code: "S23", hex: "#5CA83B" },
  { name: "S24", code: "S24", hex: "#2AAA41" },
  { name: "S25", code: "S25", hex: "#088D42" },
  { name: "S26", code: "S26", hex: "#008447" },
  { name: "S27", code: "S27", hex: "#026B5A" },
  { name: "S28", code: "S28", hex: "#007362" },
  { name: "S29", code: "S29", hex: "#006C63" },
  { name: "S30", code: "S30", hex: "#006569" },
  { name: "S31", code: "S31", hex: "#006069" },
  { name: "S32", code: "S32", hex: "#005C6D" },
  { name: "S33", code: "S33", hex: "#005576" },
  { name: "S34", code: "S34", hex: "#02557A" },
  { name: "S35", code: "S35", hex: "#005183" },
  { name: "S36", code: "S36", hex: "#065183" },
  { name: "S37", code: "S37", hex: "#164C75" },
  { name: "S38", code: "S38", hex: "#05508A" },
  { name: "S39", code: "S39", hex: "#0F4B8C" },
  { name: "S40", code: "S40", hex: "#194983" },
  { name: "S41", code: "S41", hex: "#1F3665" },
  { name: "S42", code: "S42", hex: "#26355D" },
  { name: "S43", code: "S43", hex: "#323457" },
  { name: "S44", code: "S44", hex: "#4D3D6C" },
  { name: "S45", code: "S45", hex: "#634073" },
  { name: "S46", code: "S46", hex: "#58324D" },
  { name: "S47", code: "S47", hex: "#7C3653" },
  { name: "S48", code: "S48", hex: "#9E3560" },
  { name: "S49", code: "S49", hex: "#9F3563" }
  ...
  function init() {
    ...
    pickr.on('init', (instance) => {
      ...
      if (swatches) {
        ...
        swatches.style.gridTemplateColumns = 'repeat(12, 1fr)';
